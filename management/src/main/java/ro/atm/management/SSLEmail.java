...
public class SSLEmail {
	...
	public static void sendConfirmationEmail(String toEmail, int status) {
...
//		props.put("mail.smtp.auth", "true"); // Enabling SMTP Authentication
		...
		String body = status == 1 ? "Your account has been confirmed" : "Your account has been declined";
		EmailUtil.sendEmail(session, toEmail, "Confirmation account", body);
